...
export const app = getApps().length ? getApps()[0] : initializeApp(firebaseConfig);// lib/firebase.ts
...
export const firebaseApp =
  getApps().length ? getApp() : initializeApp(firebaseConfig);// lib/firebase.ts
import { initializeApp, getApps, getApp } from "firebase/app";
