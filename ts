if (typeof window === "undefined") return null; // nan component ki 100% clientif (typeof window === "undefined") return null; // nan component ki 100% client"use client";// components/CommentsBox.tsx
