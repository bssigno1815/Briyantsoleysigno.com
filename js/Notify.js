window.BSS_SUPER_ADMIN = "briyantsoleysigno1815@gmail.com"; // youfetch('/api/notify-email',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({subject:'BSS test',text:'Email OK?'})}).then(r=>r.json()).then(console.log);
